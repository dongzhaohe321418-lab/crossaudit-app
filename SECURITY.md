...
Security fixes are made against the latest `main` release. CrossAudit 4.11.1 is
...
The 4.11.1 community DMG is ad-hoc signed and is not Apple-notarized. Verify the
